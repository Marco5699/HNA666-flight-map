...
- **数据更新**
  ...
  - `v0910`来源于海航官方在飞飞乐APP发布的数据（截至2025.09.10），该数据没有到达时刻和机型信息，在此做了补充（没有参考意义），自己整理的[v0910文档](https://www.kdocs.cn/l/cqy1AfiQ4Gcx)可供所有人查看、复制、保存。
  - 
- **版本更新**
  ...
  - 对于`v0910h`版本，UI小优化，虽然海航官方数据理论上是最准的，但是**没有到达时刻、机型信息**，所以可能或许还是`v0822g`版本好用一些。
